...
class FormatterC:
	...
	@staticmethod
	def prelude( url ):
		result = '// Generated by GenerateIconFontCppHeaders.py \n// from {!s}\n#pragma once\n\n'.format( url )
		return result

	@staticmethod
	def line_format_minmax( name, font_abbr, val ):
...
def convert_font_awesome( formatter, font_name, font_abbr, source_url, output_name ):
	try:
		...
		if response.status_code == 200:
			...
			output = formatter.prelude(source_url) + \
					 formatter.line_format_minmax( 'MIN', font_abbr, min ) + \
					 formatter.line_format_minmax( 'MAX', font_abbr, max ) + \
					 output_fonts
...
for formatter in formatters:
	convert_font_awesome( formatter, 'Font Awesome', 'FA', 'https://raw.githubusercontent.com/FortAwesome/Font-Awesome/master/src/icons.yml', 'IconsFontAwesome' )
	convert_material_design( formatter, 'Material Design', 'MD', 'https://raw.githubusercontent.com/google/material-design-icons/master/iconfont/codepoints', 'IconsMaterialDesign' )
	convert_kenney( formatter, 'Kenney', 'KI', 'https://raw.githubusercontent.com/SamBrishes/kenney-icon-font/master/css/kenney-icons.css', 'IconsKenney' )
